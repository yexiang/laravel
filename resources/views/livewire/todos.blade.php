...
Manage todos (Jetstream Livewire CRUD Example)
</h2>
</x-slot>
<div class="py-12">
...
<button wire:click="edit({{ $todo->id }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-0 px-1 rounded">Edit</button>
<button wire:click="delete({{ $todo->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-0 px-1 rounded">Delete</button>
</td>
</tr>
@endforeach
</tbody>
